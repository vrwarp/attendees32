...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        PortableRunSQL(Utility.default_sql('occasions_characters')),
        migrations.AddIndex(
        ...
        PortableRunSQL(Utility.pgh_default_sql('occasions_charactershistory', original_model_table='occasions_characters')),
