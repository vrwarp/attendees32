...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        PortableRunSQL(Utility.default_sql('persons_relations')),
        migrations.CreateModel(
        ...
        PortableRunSQL(Utility.pgh_default_sql('persons_relationshistory', original_model_table='persons_relations')),
